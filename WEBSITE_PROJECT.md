...
* Final CTA/contact: approved black/gold three-column desktop and stacked mobile layout, invitation/copy, WhatsApp, contact details, TRAINING LOCATION card, Maps and motto. Approved production correction (18 September 2026): remove only md:hidden from the solid-gold Booking → /book button, restoring it above the outlined WhatsApp button at every width. This supersedes the earlier desktop-hide decision. Existing spacing, contact details, links and responsive layout are preserved. Local Chrome review at 1440, 320, 375 and 390px passed with both buttons visible, no clipping or horizontal overflow and touch targets at least 44px. Middle column remains vertically centred on desktop. Retains id="contact"; shared header unchanged.
